...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", 'django-insecure-&i16(m%92px0uugf!61%4hccv1pu9euo#)*6km8vhyzhqb2c_+')
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": { "level": "INFO", "class": "logging.FileHandler", "filename": BASE_DIR / "django.log", "formatter": "standard"}
    },
